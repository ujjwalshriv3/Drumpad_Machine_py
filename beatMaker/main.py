...
label_font = pygame.font.Font('Azonix-1VB0.otf', 24)
medium_font = pygame.font.Font('Azonix-1VB0.otf', 16)
beat_changed = True
        ...
        for j in range(instruments):
            ...
            rect = pygame.draw.rect(screen, color,
                                    [i * ((WIDTH - 200) // beats) + 205, (j * 100) + 5, ((WIDTH - 200) // beats) - 10,
                                     90], 0, 3)
            pygame.draw.rect(screen, pinkishRed, [i * ((WIDTH - 200) // beats) + 200, j * 100, ((WIDTH - 200) // beats), 100],
                             5, 5)
